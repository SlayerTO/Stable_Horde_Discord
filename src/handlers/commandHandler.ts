...
export async function handleCommands(interaction: ChatInputCommandInteraction, client: AIHordeClient, database: mariadb.Pool | undefined, ai_horde_manager: AIHorde) {
