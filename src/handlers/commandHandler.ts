...
export async function handleCommands(interaction: ChatInputCommandInteraction, client: AIHordeClient, database: mariadb.Pool | undefined, stable_horde_manager: AIHorde) {
